...
g3charactermanagerApp.controller('CharacterController', function ($scope, resolvedCharacter, $log, $location, Character, resolvedCampaign, resolvedCharacterAdvantage, resolvedCharacterSkill, resolvedForm) {
